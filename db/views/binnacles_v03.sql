SELECT catalog_brands.id as catalog_brand_id,concepts.id as concept_id,bujias as bujias, frequency_concepts.id, concept_descriptions.nombre, concepts.descripcion,catalog_brands.descripcion as linea,frequency_concepts.tipo_frecuencia as tipo_afinacion,frequency_concepts.frecuencia_inspeccion,frequency_concepts.frecuencia_reemplazo,frequency_concepts.meses,frequency_concepts.fecha FROM frequency_concepts
