...
frequency_concepts.id, concept_descriptions.nombre, concepts.descripcion,catalog_brands.descripcion as linea,concept_descriptions.tipo_afinacion as tipo_afinacion,frequency_concepts.tipo_frecuencia as tipo_frecuencia,frequency_concepts.frecuencia_inspeccion,frequency_concepts.frecuencia_reemplazo,frequency_concepts.meses,frequency_concepts.fecha FROM frequency_concepts
