...
class SectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create section" do
    assert_difference('Section.count') do
      post sections_url, params: { section: { nombre: @section.nombre, status: @section.status } }
    end
  ...
  test "should update section" do
    patch section_url(@section), params: { section: { nombre: @section.nombre, status: @section.status } }
