...
class VehicleTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vehicle_type" do
    assert_difference('VehicleType.count') do
      post vehicle_types_url, params: { vehicle_type: { clave: @vehicle_type.clave, descripcion: @vehicle_type.descripcion, status: @vehicle_type.status } }
    end
  ...
  test "should update vehicle_type" do
    patch vehicle_type_url(@vehicle_type), params: { vehicle_type: { clave: @vehicle_type.clave, descripcion: @vehicle_type.descripcion, status: @vehicle_type.status } }
