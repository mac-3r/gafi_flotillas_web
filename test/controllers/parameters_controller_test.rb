...
class ParametersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parameter" do
    assert_difference('Parameter.count') do
      post parameters_url, params: { parameter: { nombre: @parameter.nombre, valor: @parameter.valor, valor_extendido: @parameter.valor_extendido } }
    end
  ...
  test "should update parameter" do
    patch parameter_url(@parameter), params: { parameter: { nombre: @parameter.nombre, valor: @parameter.valor, valor_extendido: @parameter.valor_extendido } }
