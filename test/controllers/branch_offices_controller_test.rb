...
class BranchOfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create branch_office" do
    assert_difference('BranchOffice.count') do
      post branch_offices_url, params: { branch_office: { catalog_company_id: @branch_office.catalog_company_id, clave_clasificacion: @branch_office.clave_clasificacion, clave_jd: @branch_office.clave_jd, descripcion: @branch_office.descripcion, status: @branch_office.status, unidad_negocio: @branch_office.unidad_negocio } }
    end
  ...
  test "should update branch_office" do
    patch branch_office_url(@branch_office), params: { branch_office: { catalog_company_id: @branch_office.catalog_company_id, clave_clasificacion: @branch_office.clave_clasificacion, clave_jd: @branch_office.clave_jd, descripcion: @branch_office.descripcion, status: @branch_office.status, unidad_negocio: @branch_office.unidad_negocio } }
